sirigueijo = Employer.create!(email: 'sirigueicho@burguer.br', password: '123456789')
...
elonmusk = Employer.create!(email: 'elon@mask.com.br', password: '123456')
...
julio = Freelancer.create!(email: 'julio@czar.com.br', password: '123456789')
...
proposal2 = Proposal.create!(message:'Eu sou o bom, confia', week_availability: '500', 
        expected_end:'01/12/2021',claim_hour: '1', project: cozinheiro, freelancer: julio)

bob = Freelancer.create!(email: 'bob@sponjao.com.br', password: '123456789')
...
proposal3 = Proposal.create!(message:'Não, contrata eu', week_availability: '30', 
        expected_end:'10/01/2021',claim_hour: '30', project: cozinheiro, freelancer: bob)